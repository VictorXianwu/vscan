    ...
    def get(self,uuid):
        ...
        if status == "error":
           self.render("index.html", Data = u"二维码错误！", Image = "")
            ...
            self.render("index.html", Data = text, Image = "http://qr.liantu.com/api.php?m=5&w=150&el=q&logo=http://i2.tietuku.com/ba066af48fa5677a.png&text=http://vscan.sinaapp.com/qrcode/"+uuid)
